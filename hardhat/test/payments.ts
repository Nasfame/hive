...
describe("Payments", () => {
    ...
    async function setupPayments() {
        const {payments, token} = await setupPaymentsFixture({
            testMode: true,
            withFunds: true,
        });
    ...
    async function setupPaymentsWithAgreement() {
        const {payments, token, tokenAddress} = await setupPayments();
    ...
    async function setupPaymentsWithResultsCheck() {
        const {payments, token, tokenAddress} = await setupPaymentsWithResults();
    ...
    describe("Results", () => {
        ...
        it("Should check a result", async function () {
            ...
            await expect(
                ...
                .withArgs(tokenAddress, getAddress("job_creator"), timeoutCollateral)
                .to.emit(token, "Transfer")
                .withArgs(getAddress("job_creator"), tokenAddress, mediationFee);
    ...
    describe("Mediation", () => {
        ...
        it("Should reject mediation results", async function () {
            ...
            await expect(
                ...
                .to.emit(token, "Transfer")
                .withArgs(tokenAddress, getAddress("admin"), resultsCollateral)
                .to.emit(token, "Transfer")
    ...
    describe("Timeouts", () => {
        ...
        it("Should timeout mediate results", async function () {
            ...
            await expect(
                ...
                .withArgs(tokenAddress, getAddress("job_creator"), paymentCollateral)
                .to.emit(token, "Transfer")
                .withArgs(tokenAddress, getAddress("job_creator"), mediationFee);
