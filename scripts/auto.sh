...
go list -m -json github.com/CoopHive/hive@latest

go list -m -json github.com/CoopHive/hive/exp/dealer/goczmqExampleDealer@latest
#go run github.com/CoopHive/exp/basic@$tag
